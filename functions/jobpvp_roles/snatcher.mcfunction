...
execute if score game jobpvp_gameState matches 1 run execute as @a[tag=jobpvp_role_snatcher] run execute unless entity @s[hasitem={item=iron_sword}] run give @s slime_ball 30 0
execute if score game jobpvp_gameState matches 1 run execute as @a[tag=jobpvp_role_snatcher] run execute unless entity @s[hasitem={item=iron_sword}] run give @s magma_cream 3 0
